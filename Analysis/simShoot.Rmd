...
params <- c("N0","N", "x", "mu", "mu_pred", "p.cull")
...
hist(post[,"N0"], main="Initial population size")
...
hist(post[,'x[1]'], main="Initial population density", probability=TRUE)
hist(post[,'x[1]'], main="Initial population density", probability=TRUE, xlim=c(0,100))
# add prior
...
```{r, fig.cap="Posterior estimates for fitting model to shooting data of feral pigs from the Mary River Floodplain."}
par(mfrow=c(2,2))
hist(post[,'N[1]'], main= "Initial population size", probability=TRUE)
hist(post[,'x[1]'], main="Initial population density", probability=TRUE)
