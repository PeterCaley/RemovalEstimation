...
Hone1986 <- data.frame(
  Day=1:9,
  Effort=c(0.015, 0.022, 0.016, 0.006, 0.16, 0.018, 0.007, 0.019, 0.016),
...
Hone1986$Kills <- round(Hone1986$KillsKm2*295)
...
# TypeIII example
simTypeIII <- simShoot(n0=20, A=100, T=10, c.max=50, beta1=20, k=4, effort.mu=8, effort=NULL, searchFunc="TypeIII" )
# Plot it
with(simTypeIII, {
  par(mfrow=c(1,2))
  plot(t, cull.no, type="h", lwd=2, ylim=c(0, max(cull.no)), ylab="Removals", xlab="Session", axes=FALSE)
